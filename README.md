...
`config.yml` master configuration file paths:
input_dir - input data
analysis_dir - output folder for `scripts/analysis` organised per chapter.
figures_dir - output folder for `scripts/figures` organised per chapter.
